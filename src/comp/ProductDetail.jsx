          ...
          <div className="col-md-6 mb-4">
            ...
            <div className="d-flex justify-content-between">
              <img
                ...
                onClick={(event) => changeImage(event, event.target.src)}
              />
              <img
            ...
            <div className="mb-4">
              ...
              >
                ...
                <input
                  ...
                  autocomplete="off"
                />
                <label className="btn btn-outline-secondary" for="silver">
                  Silver
                </label>
                <input
                  type="radio"
                  ...
                  autocomplete="off"
                />
                <label className="btn btn-outline-primary" for="blue">
                  Blue
                </label>
              </div>
            </div>
